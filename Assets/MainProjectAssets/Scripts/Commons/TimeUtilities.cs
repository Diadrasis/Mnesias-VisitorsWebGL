...
public static class TimeUtilities
{
    ...
    public static string GetNowDateAndHourTimeString()
    {
        return DateTime.Now.ToString("yyyy'-'MM'-'dd'_'HH'_'mm'_'ss");
    }

    public static string GetNowDateAndHourTimeString2()
    {
        return DateTime.Now.ToString("yyyy'-'MM'-'dd' 'HH':'mm':'ss");
    }

    public static string GetNowDateTimeSaveString()
    {
        return DateTime.Now.ToString("yyyyMMdd");
    }

    public static string GetDetailedNowDateTimeSaveString()
    {
    ...
    public static bool IsDatePast(DateTime target)
    {
        if(target == DateTime.Today) { return true; }

        double result = GetUTCUnixTimestamp(DateTime.Today) - GetUTCUnixTimestamp(target);
