...
public static class SavWav
{
    ...
    public static void SaveToPath(string filepath, string filename, AudioClip clip, bool trim = false)
    {
    ...
    public static void SaveTo(string filepath, AudioClip clip, bool trim = false)
    {
        Debug.Log(filepath);
